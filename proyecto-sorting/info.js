// Almacena la información de clasificación de los algoritmos
const CLASSIFICATION_DATA = {
    ...
    "Hash Sort": {
        complejidad: "O(n+k log k) (k=claves únicas)",
        estable: "Sí (depende del sort de claves)",
        inPlace: "No (requiere Map y arreglo nuevo)",
        tipo: "No Comparativo (Distribución)",
        estrategia: "Distribución (conteo)",
        determinista: "Sí",
        ventajas: "Muy rápido si el número de claves únicas (k) es mucho menor que n.",
        desventajas: "Usa memoria extra (O(k)). El rendimiento depende del sort de claves.",
        idealPara: "Datos con muchos valores repetidos."
    },
    "Bucket Sort": {
