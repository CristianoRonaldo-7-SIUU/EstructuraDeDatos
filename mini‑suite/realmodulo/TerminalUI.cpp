...
void TerminalUI::iniciar() {
    ...
    do {
        ...
        if (operacion == "mkdir") {
            ...
            // El origen suele ser nombre simple si usamos find, o ruta?
            // El core usa buscarRecursivo para MV?
            // Reusando obtenerPunteroRecursivo en core, busca por NOMBRE simple.
            getline(cin, nombre); 
